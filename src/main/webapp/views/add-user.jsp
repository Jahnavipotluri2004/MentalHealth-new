...
<head>
    ...
    <style>
        body {
            ...
            background-image: url('https://www.turnbridge.com/wp-content/uploads/2023/05/AdobeStock_474018927-scaled.jpeg'); /* Same image as login page */
            background-size: 100% 100%; /* Adjusts the image size to fill the entire background */
            background-position: center; /* Centers the image */
            background-repeat: no-repeat; /* Prevents the image from repeating */
            color: #333; /* Keep the text color for the page content */
            padding: 20px;
        ...
        .container {
            ...
            max-width: 500px;
            margin: auto;
            margin-top: 100px; /* Adjust position on the background */
        }
        h2 {
            text-align: center;
            color: #333;
        ...
        #rocket {
            ...
            width: 200px; /* Width for the rocket image */
...
<body>
    <div class="container">
        ...
        <form action="add-user" method="post" onsubmit="showRocket(event)">
