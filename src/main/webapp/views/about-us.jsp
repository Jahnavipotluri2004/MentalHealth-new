...
<body>
    ...
    <img id="chat-icon" src="https://play-lh.googleusercontent.com/5U-Os0lxyeuPC5OkdlcCtt2PEpNKLEgG_vmDKc_WCrWD3FlQKvXH_LEM6zXooJs43OA" 
         alt="Chat with us" class="chat-icon" 
