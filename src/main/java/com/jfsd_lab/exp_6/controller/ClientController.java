...
public class ClientController {
    ...
    public ModelAndView registerEvent(@PathVariable("eventId") int eventId, HttpSession session) {
        ...
        // Fetch the updated list of events to display
        List<Event> allEvents = eventService.getAllEvents(); // Fetch all events
        mv.addObject("allEvents", allEvents); // Add events to the model
        return mv;
    }

    // Changed the mapping for about us view to avoid conflicts
    @GetMapping("/about-us")
    public ModelAndView aboutUsView() {
        return new ModelAndView("about-us"); // This assumes your JSP is named aboutus.jsp
    }
    @GetMapping("/registered-events")
    public ModelAndView registeredeventsView() {
        return new ModelAndView("registered-events"); // This assumes your JSP is named aboutus.jsp
    }
    @GetMapping("/councellor")
    public ModelAndView councellorView() {
        return new ModelAndView("councellor"); // This assumes your JSP is named aboutus.jsp
    }
    @GetMapping("/games")
    public ModelAndView gamesView() {
        return new ModelAndView("games"); // This assumes your JSP is named aboutus.jsp
    }
    @GetMapping("/read-buy")
    public ModelAndView readbuyView() {
        return new ModelAndView("read-buy"); // This assumes your JSP is named aboutus.jsp
    }
